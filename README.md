...
4. Define all joints between the links and call them `EXPORT_joint_name`. Select child as `Component1` and parent as `Component2`. Child and parent component must belong to two different rigid groups, e.g. links. Supported joint types are: fixed, revolute, prismatic and ball.
